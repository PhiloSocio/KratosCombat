...
* Some advanced shit.
* Compatible with SE and AE game versions. _(tested with 1.5.97, 1.6.x, 1.7.x)_
...
* [Ersh](https://github.com/ersh1) for Precision API and projectile hook ID's. For amazing precision and OAR repositories.
